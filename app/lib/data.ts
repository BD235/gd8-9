...
export async function fetchCardData() {
  try {
    console.log('Fetching dashboard card data...');
    ...
    return {
      numberOfInvoices: Number(invoiceCountData[0].count ?? '0'),
      numberOfCustomers: Number(customerCountData[0].count ?? '0'),
...
// Get total invoice pages based on search
...
// Fetch filtered customers for table
